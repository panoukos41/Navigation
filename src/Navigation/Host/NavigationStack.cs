...
{
    private readonly Subject<Url> _change = new();
    private readonly Subject<Url> _pushed = new();
    private readonly Subject<Url> _popped = new();
    ...
    public NavigationStack(IEnumerable<Url> requests) : base(requests)
    {
    }
    ...
    public new Unit Push(Url request)
    {
        base.Push(request);
    ...
    public string ToJson(bool indented = false)
    {
        ...
        void AppendRequest(Url request)
        {
    ...
    public static NavigationStack Parse(string json)
    {
        ...
        {
            ((Stack<Url>)stack).Push(Url.Parse(item.Trim('"')));
        }
    ...
    {
        return other is Stack<Url> stack
            && Equals(stack);
    }

    /// <inheritdoc/>
    public bool Equals(Stack<Url>? other)
    {
